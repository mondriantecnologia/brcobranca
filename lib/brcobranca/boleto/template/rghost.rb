    ...
    module Template
      ...
      module Rghost
        ...
        def modelo_mondrian_cabecalho(doc, boleto, opts = {:logo => 80})
          ...
          # Linha 1
          doc.text_area "<negrito>#{boleto.cedente} - #{boleto.documento_cedente}</negrito>", :x => "0.7 cm",   :y => "19.42 cm", :width => "7.0 cm" #"7.5 cm"
        ...
        def modelo_mondrian_rodape(doc, boleto, opts = {:logo => 80})
          ...
          # Linha 2
          doc.text_in :write => "#{boleto.cedente} - #{boleto.documento_cedente}",  :x => "0.7 cm",  :y => "11.2 cm", :tag => :negrito  
